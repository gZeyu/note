...
### 5.7.3 利用反射分析类的能力
### 5.7.4 在运行时使用反射分析对象
- 反射机制的默认行为受限于 **Java** 的访问控制，可调用 **Filed**、**Method** 和 **Construct** 的 **setAccessible** 方法yu
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE2MzA4NzkwOSw1MTI5NjcwNTYsLTE2Nz
c1ODM1ODEsMTE5MzM0MjEyNSwxMjgzNDM4ODMwLDIzNTgyNDQ3
NywtOTAwMzE2NjM1LC0xNDUxNDkxNjA3LC01NjkwMTgxOCwtOD
AzNzcyMzU1LDQ0ODMwODYwOSwtMTk2MzI5MDA0MywxMTQzNDc1
NzAsMjA0NzM3OTg2OSw5MTY0MDQzNjMsLTg2NzY5OTUyMiwxMT
AwNjYyMzAsMzk1MTc1MjMzLC0xNTMyNTk0NTAzLDE1MTExNzMy
NzFdfQ==
-->