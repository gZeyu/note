...
- 所有数组类型都扩展了 **Object** 类
### 5.2.1 **equals** 方法
- 为了防止两个比较对象都为 **null** 的情况，需要使用
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3MDU1MTI5MiwtMTEwOTI1ODAzLC0yMT
...
NDAwMDAsLTg5NDczNTI1NCwtMTI1NzQzMjc3OSwtNDkwMzM5OT
c1LC0zNDE3NTc3ODYsLTE0MTIxNjQyMzksLTQ1MTU5MTM0OCwx
NjgzNDkyMDk3XX0=
-->