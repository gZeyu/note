...
- 使用 **Constructor** 类中的 **newInstance** 方法也可以动态地创建一个类的实例，该方法会调用有参数构造器来初始化新创建的对象
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0Mzg5MjMyMywxMjgzNDM4ODMwLDIzNT
gyNDQ3NywtOTAwMzE2NjM1LC0xNDUxNDkxNjA3LC01NjkwMTgx
OCwtODAzNzcyMzU1LDQ0ODMwODYwOSwtMTk2MzI5MDA0MywxMT
QzNDc1NzAsMjA0NzM3OTg2OSw5MTY0MDQzNjMsLTg2NzY5OTUy
MiwxMTAwNjYyMzAsMzk1MTc1MjMzLC0xNTMyNTk0NTAzLDE1MT
ExNzMyNzEsLTU3MTMyNzUzOCw4MDc4NTkyMjksMTM3NzE1Nzc1
Ml19
-->