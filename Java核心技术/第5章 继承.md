...
- 重写 **hashcode** 方法是为了让我们能够正常使用 **HashMap** 等集合类，因为 **HashMap** 判断对象是否相等既要比较 **hashcode** 又要使用 **equals** 比较。而这样的实现是为了提高 **HashMap** 的效率。（这里默认**hashcode** 比 **equals** 高效）
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg2NzY5OTUyMiwxMTAwNjYyMzAsMzk1MT
