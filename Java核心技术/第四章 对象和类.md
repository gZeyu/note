...
# windows
java -classpath c:\classdir;.;c:\archives\archive.jar HyProg
```
- 也可以设置环境变量
``` shell
# unix
...
- **javadoc**
### 4.9.1 注释的插入
- 文档注释可以使用 **HTML** 修饰符( 注意 **\<h1\>** 或 **\<hr\>** 会与文档格式冲突)
### 4.9.2 类注释
...
- 一定要对数据初始化
- 不要在类中使用过多基本类型
- 不是所有域都需要独立的域访问器与与域更改器
- 将自责过多的类进行分解
- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1MTM1NDAsMTc3NTMzMzQ5MywyMTMxND
c2MTM3LC0xNjEzMDQzMzc1LDU0NzkwMTU0OSw2NDE3MTIyNTYs
LTEyMTU5ODQ3MDAsLTIxMDczMzUxNTUsMTM3MDE5OTE1NywxOD
E3OTcxODg3LDg4NjQ1OTUwNiwtMTkxNzc1OTUwNSw2NDcyNTcx
ODYsLTQ2Njk4MTQ5NiwxMDg5OTc1NTQzLC0xNTg3NTkxNTEzLC
01MTk5NjgyMzIsLTg0Njk2ODM0NiwtMjAzMTQ0NTk5LC0xODU5
MTY5MDM5XX0=
-->