...
## Approach 2
### 思路
可以使用回溯法求解该问题。该问题等价于能否寻找一个能够拆解字符串为字典内单词的可行解，假设解可以由向量$(x_i,x_2,...,x_n)$表示，$x_i\in wordDict$。该解空间构成的子集树的每个节点的分支数量取决于
$$
dp[i] = 
\begin{cases}
 true &if\; i=0\\
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1NDc3Njk1MywtMzM0NDA2Mzc3LDM2NT
