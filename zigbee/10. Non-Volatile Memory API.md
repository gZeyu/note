...
## Note
CC2530闪存使用2k页。 显然，OSAL NV不操纵数据项跨页，即项目不能部分存储在第1页，其余部分存储在第2页。因此，最大项目大小可以存储为2048(byte) - 8(page header) - 8(item header) = 2032 bytes
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDAxNzU1OTQ1LDEyOTUyNzIxNjJdfQ==
-->