...
## Note
CC2530闪存使用2k页。 显然，OSAL NV不会让 **NV** 项跨页，即 **NV** 项不能部分存储在第1页，其余部分存储在第2页。因此， **NV** 项最大存储字节数为2048(byte) - 8(page header) - 8(item header) = 2032 bytes
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzOTgwMDA5NjEsMTI5NTI3MjE2Ml19
-->