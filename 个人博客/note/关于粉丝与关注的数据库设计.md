...
### 查询两个用户关系状态
```sql
select sum(follower = user_a_id and followed = user_b_id)+sum(follower = user_a_id and followed = user_b_id) from blog_follower 
```
## 参考
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1MzI5MTU4OCw3MjkyOTIzNDAsMTgzMD
c5MTMwLC0xMzY5NDY2MzIyLDEyNTQ4ODg0NjEsMTkxMTMwNzAy
NywyMTMzNTQ3MTczLDUzMTkzMDUzMywyNDA1ODM4MjgsNDk3Nj
