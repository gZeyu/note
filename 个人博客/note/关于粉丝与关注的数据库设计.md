...
### 查询用户的关注列表
```sql
select follower from blog_follower WHERE followed = username
```

### 查询用户的粉丝列表
```sql
select followed from blog_follower WHERE followed = 1
```
## 参考
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODM5NjI1MTU3LDIxMzM1NDcxNzMsNTMxOT
