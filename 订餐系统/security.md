...
`UsernamePasswordAuthenticationFilter`解析`HttpServletRequest`提取登录参数，生成`UsernamePasswordAuthenticationToken`并传给`DaoAuthenticationProvider`

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQwODM2NTU5NSw0NDA0NDI4NjAsLTE2OD
