...
#### 满减优惠
```
o_full_reduction_offer(id, shop_id, atisfy)
```
#### 折扣优惠
```
o_shop_menu(id, item)
```
```
o_shop_menu_product(id, menu_id, product_id)
```
### 订单管理
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwODExMjM1MzQsMTMyMzEyODk2MSw2OD
cwNzA5MTYsLTM1NDA2NDM1NSwzMDAzOTYzNjIsLTEzMTE1MzU1
MjAsMTY4ODE3NTg1OSwtMjAwMzE2NjYyOSwtNTU4OTk2NzA3LD
EwOTc4MTg0MzUsMjAxOTgyMzEzLC0xNzc0NDAzNzM0LDE4Nzg2
NzU1NzQsLTE4MzgwNDI1MDYsLTE2NjIxMjg0MjEsLTMwNTY1MT
YwMiwtMTg0OTczNzMyLDEzMzI1NzEwMywtNDkxNzgyNDM2LDEw
NTc1NTE5ODldfQ==
-->