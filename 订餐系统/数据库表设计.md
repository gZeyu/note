...
#### 订单表
```
o_order(id, order_serial_number, user_id, shop_id, orderer_name, orderer_phone_number, orderer_address, product_id, price)
```
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAxNDQ5MzM5NiwxMDM5ODEwOTUyLDU1MD
A1MzY5MSwxMzIzMTI4OTYxLDY4NzA3MDkxNiwtMzU0MDY0MzU1
LDMwMDM5NjM2MiwtMTMxMTUzNTUyMCwxNjg4MTc1ODU5LC0yMD
