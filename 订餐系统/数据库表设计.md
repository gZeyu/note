...
```
o_order(id, order_serial_number, user_id, shop_id, orderer_name, orderer_phone_number, orderer_address, product_i)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk0OTEzMzE5OCwtMTM0Nzg5MTIyNywxMD
