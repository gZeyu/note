...
#### 订单表
```
o_order(id, order_no, user_id, nickname, phone_number, address, products, full_reduction_offer, coupon, total_price)
```
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTIyODI1ODcsMTAzOTgxMDk1Miw1NT
AwNTM2OTEsMTMyMzEyODk2MSw2ODcwNzA5MTYsLTM1NDA2NDM1
NSwzMDAzOTYzNjIsLTEzMTE1MzU1MjAsMTY4ODE3NTg1OSwtMj
